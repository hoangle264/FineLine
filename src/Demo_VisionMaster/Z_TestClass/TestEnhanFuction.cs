...
{
    public class TestEnhanFuction
    {
        public TestEnhanFuction() { }
        ...
        public void Run(string ImageFile)
        {
            try
            {
                ...
                stOutputImage.SaveImage("C:\\Users\\Dell\\Desktop\\VisionParket\\VisionParket\\Image\\Temp.bmp");
                Bitmap bitmap = null;
                bitmap = stOutputImage.GetBitmap();
        ...
        public void Run(Bitmap StreamingImage)
        {
            ...
            {
                m_stInputImage = new CMvdImage();
                m_stInputImage.InitImage(StreamingImage);
                if ((null == m_stImageEnhanceToolObj) || (null == m_stInputImage))
                {
                    throw new MvdException(MVD_MODULE_TYPE.MVD_MODUL_TOOL, MVD_ERROR_CODE.MVD_E_CALLORDER);
                }
